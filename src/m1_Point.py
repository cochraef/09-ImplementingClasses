...
# ------------------------------------------------------------------------------
# 2: DONE         With your instructor, READ THE INSTRUCTIONS in
...
class Point(object):
    ...
    def move_to(self, x, y):
        ...
        move_distance = Point.get_distance_from(self, point_prev)
        self.total_distance = self.total_distance + move_distance
    ...
    def get_distance_from_start(self):
        point = Point(self.starting_x, self.starting_y)
    ...
    def halfway_to(self, point):
        x_ave = (self.x + point.x) / 2
        y_ave = (self.y + point.y) / 2
        return Point(x_ave, y_ave)
...
def run_test_repr():
    ...
    """
    # --------------------------------------------------------------------------
    # 4: DONE  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_clone():
   ...
   """
    # --------------------------------------------------------------------------
    # 5: DONE  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_move_to():
    ...
    """
    # --------------------------------------------------------------------------
    # 6: DONE  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_move_by():
    ...
    You may also use this example to test this method.
        ...
        """
    # --------------------------------------------------------------------------
    # 7: DONE  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_number_of_moves_made():
    ...
    """
    # --------------------------------------------------------------------------
    # 8: DONE  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_distance_from():
    ...
    """
    # --------------------------------------------------------------------------
    # 9: DONE  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_distance_from_start():
    ...
    """
    # --------------------------------------------------------------------------
    # 10: DONE  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_distance_traveled():
    ...
    """
    # --------------------------------------------------------------------------
    # 11: DONE  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_closer_to():
    ...
    """
    # --------------------------------------------------------------------------
    # 12: DONE  Follow the same instructions as in TO-DO 3 above,
...
def run_test_halfway_to():
    ...
    """
    # --------------------------------------------------------------------------
    # 13: DONE  Follow the same instructions as in TO-DO 3 above,
